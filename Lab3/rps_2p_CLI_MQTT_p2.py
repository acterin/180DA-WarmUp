...
topic_publish = "rps_game/player2_to_player1"  # Topic to publish player's choice
topic_subscribe = "rps_game/player1_to_player2"  # Topic to subscribe for opponent's choice
