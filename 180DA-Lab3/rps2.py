...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("ece180d/jkwon/rps1", qos=1)
...
def play_rps():
    ...
    if (int(message.payload.decode()) == 0):
        player1_choice = get_player_1st_choice()
...
while True: 
    client.publish("ece180d/jkwon/rps2", int (count), qos=1)
    play_rps()
    pass 
